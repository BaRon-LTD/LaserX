...
public class bubbleHit : LaserInteractable
{
    ...
    [SerializeField] private AudioSource bubbleAudioSource; // Audio source for the bubble sounds
    [SerializeField] private AudioClip bubblePopSound; // Sound to play when the bubble pops
    [SerializeField] private AudioSource coinAudioSource; // Audio source for the coin sounds
    [SerializeField] private AudioClip coinCollectSound; // Sound to play when the coin is collected
    ...
    public override void OnLaserHit(ref bool stopRay)
    {
        ...
        // Play the BubblePop sound
        if (bubbleAudioSource != null && bubblePopSound != null)
        {
            bubbleAudioSource.PlayOneShot(bubblePopSound);
        }
    ...
    private IEnumerator MoveCoinToUI()
    {
        ...
        // Play the CoinCollect sound at the target position
        ...
        // // Immediately destroy the Coin
        // Destroy(coin);

        // Optionally, update the UI counter here or trigger further logic
        Debug.Log("Coin collected and disappeared!");
    }
